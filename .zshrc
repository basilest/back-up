...
export HISTSIZE=10000             #sbasile
export SAVEHIST=$HISTSIZE         #sbasile
...
#ZSH_THEME="robbyrussell"      #sbasile: commented out default to try powerline10k
...
plugins=(git
         zsh-autosuggestions        #sbasile
)
ZSH_AUTOSUGGEST_BUFFER_MAX_SIZE=100   # sbasie (default 20)
...
#source ~/.iterm2_shell_integration.zsh   # to have iterm2 shell integration. Note the file comes down as:
